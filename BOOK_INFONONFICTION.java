...
public class BOOK_INFONONFICTION {
...
try {// Load the MySQL driver
    ...
    ResultSet resultSet = statement.executeQuery("SELECT TITLE FROM BOOK_DETAILS WHERE TITLE = "+"'"+ NONFICTIONAL_PAGE.buttonlbl+"';");
    ...
    resultSet = statement.executeQuery("SELECT ISBN FROM BOOK_DETAILS WHERE TITLE = "+"'"+ NONFICTIONAL_PAGE.buttonlbl+"';");
    while (resultSet.next()) {
    ...
    resultSet = statement.executeQuery("SELECT CATEGORY FROM BOOK_DETAILS WHERE TITLE = "+"'"+ NONFICTIONAL_PAGE.buttonlbl+"';");
    while (resultSet.next()) {
    ...
    resultSet = statement.executeQuery("SELECT AUTHOR FROM BOOK_DETAILS WHERE TITLE = "+"'"+ NONFICTIONAL_PAGE.buttonlbl+"';");
    while (resultSet.next()) {
    ...
    resultSet = statement.executeQuery("SELECT PUBLISHER FROM BOOK_DETAILS WHERE TITLE = "+"'"+ NONFICTIONAL_PAGE.buttonlbl+"';");
    while (resultSet.next()) {
    ...
    resultSet = statement.executeQuery("SELECT STATUS FROM BOOK_DETAILS WHERE TITLE = "+"'"+ NONFICTIONAL_PAGE.buttonlbl+"';");
    while (resultSet.next()) {
