...
//FORM
JLabel label3 = new JLabel("ACADEMIC BOOKS");
f.add(label3);
...
f.add(label4);
label4.setBounds(350, 320,700, 1);
...
JButton D=new JButton("HOME ");
D.setBounds (120, 830,180, 50);
...
panel.setBounds(350, 220,700, 700);
